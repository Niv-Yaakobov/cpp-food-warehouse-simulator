...
class Volunteer {
    public:
        ...
        virtual string getType() const = 0; //return "Driver" or "Collector" base on the volunteer's type
        virtual ~Volunteer() = default; // Make the destructor virtual
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        virtual ~CollectorVolunteer() = default; // Make the destructor virtual
...
class LimitedCollectorVolunteer: public CollectorVolunteer {
    ...
    public:
        ...
        virtual ~LimitedCollectorVolunteer() = default; // Make the destructor virtual
...
class DriverVolunteer: public Volunteer {
    ...
    public:
        ...
        string toString() const override;
        string getType() const;
        virtual ~DriverVolunteer() = default; // Make the destructor virtual
...
class LimitedDriverVolunteer: public DriverVolunteer {
    ...
    public:
        ...
        string toString() const override;
        virtual ~LimitedDriverVolunteer() = default; // Make the destructor virtual
